...
def logChapterHistory(chapter = None, content = None, raw_content = None, user = None, comment = '', revision = None):
    """
...
# logSectionHistory
def logSectionHistory(section = None, content = None, raw_content = None, user = None, comment = '', revision = None):
    """
    Creates history record for chapter change.

    @type section: C{booki.editor.models.Section}
    ...
    try:
        history = models.SectionHistory(section = section,
                                        content = content,
                                        raw_content = raw_content,
                                        user = user,
                                        revision = revision,
