...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DiscussionTheme'
        db.create_table('editor_discussiontheme', (
            ...
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now=True)),
        ))
        db.send_create_signal('editor', ['DiscussionTheme'])
        
        # Adding model 'DiscussionComment'
        db.create_table('editor_discussioncomment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('discussiontheme', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['editor.DiscussionTheme'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('comment', self.gf('django.db.models.fields.TextField')()),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now=True)),
            ('nro_likes', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('editor', ['DiscussionComment'])
       

    def backwards(self, orm):
         # Deleting model 'DiscussionTheme'
        db.delete_table('editor_discussiontheme')
         # Deleting model 'DiscussionComment'
        db.delete_table('editor_discussioncomment')
